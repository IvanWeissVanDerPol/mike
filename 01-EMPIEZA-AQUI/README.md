# 🚀 EMPIEZA AQUÍ - Tu Punto de Entrada

**Para:** Mikie Moyano Nakamura  
**Estado:** Estudiante fisioterapia (último año)  
**Meta:** Lanzar práctica de masajes en 7 días
...
**Qué contiene:**
- Días 1-2: Compras (Gs. 400K)
- Día 3: Setup sistema tracking
- Día 4: Aprender técnicas básicas
- Días 5-6: Contactar amigos
- Día 7: Primera sesión

**Resultado:** En 7 días tenés tu primer cliente pagando.
...
**Qué contiene:**
- 🛡️ Protección legal (consentimiento, descargos)
- 💰 Protección pago (prepago, cancelaciones)
- 🚨 Seguridad física (compartir ubicación, límites)
- 🩹 Protocolo lesiones (qué hacer si cliente se lastima)
- 🧠 Salud mental (manejar rechazo, burnout)

**POR QUÉ ES CRÍTICO:**
- Sin esto → Expuesto a demandas, lesiones, robos
- Con esto → Protegido legalmente y físicamente

**NO SALTEAR ESTE ARCHIVO.**
...
**Si completaste todo esto → ¡Estás listo para lanzar!**

---

## ❓ PREGUNTAS FRECUENTES

**P: No tengo Gs. 400K para suministros. ¿Qué hago?**  
R: Ver `02-IMPLEMENTACION/MES-1-LANZAMIENTO.md` (opción presupuesto bajo - Gs. 350K mínimo)

**P: ¿Qué pasa si solo 2-3 amigos dicen sí?**  
R: Ver `02-IMPLEMENTACION/PROYECCIONES-FINANCIERAS.md` (Escenario 1 - Pesimista + Plan B)

**P: ¿Qué hago si cliente se lastima?**  
R: Ver `GESTION-RIESGOS.md` (sección Protocolos de Lesión)

**P: ¿Qué hago si me siento inseguro con cliente?**  
R: TERMINAR SESIÓN INMEDIATAMENTE. Salir. Tu seguridad > su pago.

**P: ¿Cuándo debería renunciar si no funciona?**  
R: Darle 90 días de esfuerzo honesto. Si cero progreso, pivotar a Plan B (trabajo asistente PT).
...
Amigo/Familiar: _________________ [Teléfono: _______]
Mentor: _________________________ [Teléfono: _______]
PT Licenciado: __________________ [Teléfono: _______]
```
...
Muchos estudiantes leen TODO y nunca empiezan.

**El mejor plan:**
1. Leer INICIO-RAPIDO
2. Leer GESTION-RIESGOS
3. Empezar

**No necesitás ser perfecto. Necesitás empezar.**
...
**AHORA MISMO:**  
Abrir `INICIO-RAPIDO.md` y leer los Días 1-2 (compras).

**MAÑANA:**  
Ir de compras.

**EN 7 DÍAS:**  
Primera sesión pagada.
