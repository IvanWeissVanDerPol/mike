...
**Propósito:** Estrategias específicas para adquisición de clientes
...
- **Estrategia:** Alianzas con gimnasios y centros deportivos
- **Contenido:**
  - 15+ gimnasios identificados (Smart Fit, Exen Gym, Golden Gym, etc.)
  - Modelo de convenio (descuentos, comisiones, charlas)
  - Script de acercamiento a gerentes/dueños
  - Beneficios para ambas partes
- **Estado:** ⚠️ 60% completo (falta obtener contactos directos)
- **Timing:** Ejecutar en Mes 2-3 (después primeras sesiones)

### **02-red-referidos-medicos.md**
- **Estrategia:** Red de referidos con médicos especialistas
- **Contenido:**
  - Especialidades prioritarias (traumatología, deportología, reumatología)
  - Hospitales objetivo (Británico, Bautista, Boquerón)
  - Sistema de comunicación médico-fisio (informes)
  - Modelo de relación profesional
- **Estado:** ⚠️ 60% completo (falta listar 20-30 traumatólogos)
- **Timing:** Ejecutar en Mes 13+ (después de licencia)

### **03-estrategia-espacios-publicos.md**
- **Estrategia:** Presencia en eventos deportivos y espacios públicos
- **Contenido:**
  - Torneos EXA (ex-alumnos)
  - Ferias de salud y bienestar
  - Alianzas con puestos en Costanera/Ñu Guasu
...
**Fase 1 (Meses 1-3): Boca a Boca**
- Enfoque: Amigos directos y referencias personales
- Sin marketing público (estudiante sin licencia)

**Fase 2 (Meses 2-4): Gimnasios**
- Alianzas con 2-3 gimnasios cercanos
- Charlas sobre lesiones deportivas
- Descuentos para socios del gimnasio

**Fase 3 (Meses 4-8): Eventos**
- Presencia en torneos EXA
- Stands en ferias de salud
- Masajes post-carrera en eventos deportivos

**Fase 4 (Mes 13+): Red Médica**
- Acercamiento a traumatólogos
...
**Restricción legal (Meses 1-12):**
- NO publicidad pública masiva (Instagram, volantes)
- NO reclamar tratamientos médicos
- SÍ boca a boca controlado
- SÍ alianzas privadas con gimnasios

**Post-licencia (Mes 13+):**
- Todas las estrategias permitidas
- Marketing profesional completo
