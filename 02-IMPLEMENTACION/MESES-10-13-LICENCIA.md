# 🎓 PLAN TRANSICIÓN POST-LICENCIA (Meses 10-13)

> **Para**: Mikie Moyano Nakamura  
> **Propósito**: Transición de práctica masaje estudiante a fisioterapeuta profesional licenciado  
> **Plazo**: Octubre 2026 → Enero 2027 (graduación + licencia)  
> **Crítico**: Este período de 4 meses determina tu éxito lanzamiento profesional
...
- ✅ Demanda probada para tus servicios

---

## 📅 MES 10: APLICACIÓN LICENCIA + EQUIPO (Octubre 2026)

**Tema Clave:** EMPEZAR proceso burocrático temprano (es lento)

---

### **SEMANA 1 (Oct 1-7): Investigación Licencia y Prep Aplicación**
...
- [ ] Confirmar documentos requeridos:
  ...
  - [ ] Certificado nacimiento (original + copia)
  - [ ] Certificado antecedentes policiales
  - [ ] Cédula (paraguaya)
  - [ ] Fotos pasaporte (2-3 recientes)
  - [ ] Formulario aplicación (formulario de matrícula)
- [ ] Confirmar tiempo procesamiento (típicamente 4-8 semanas)
...
#### **Tarea 2: Preparar Registro Negocio (RUC Profesional)**

**Estado actual:** Tenés RUC RESIMPLE para masaje (informal)  
...
- [ ] Entender implicaciones fiscales:
  ...
  - IVA + IRE: Requerido si excede Gs. 80M/año
  - Servicios profesionales: 10% IVA típicamente
- [ ] Confirmar podés mantener RESIMPLE (probablemente sí, si ingresos proyectados <Gs. 80M primer año)
- [ ] Preparar documentos para actualización RUC post-licencia

**Nota:** No actualizar RUC hasta tener licencia profesional en mano.

---

#### **Tarea 3: Planificación Compra Equipo**

**Problema:** Estuviste usando equipo mínimo (pistola masaje, aceites, toallas)  
**Necesidad:** Equipo grado profesional para práctica licenciada
...
- [ ] Presupuesto: Asignar Gs. 10M de ahorros para equipo

**Timing:** Comprar equipo en Mes 11-12 (después confirmar te vas a graduar)

---

### **SEMANA 2-4 (Oct 8-31): Estrategia Transición Precio**
...
**La brecha:** Aumento precio 2-3x

**El riesgo:** Clientes existentes se sienten traicionados ("¿Estás duplicando precios a tus amigos?")

---

#### **Estrategia Transición Precio (Enfoque 3 Pasos):**

**PASO 1: Pre-Anunciar (Mes 10 - AHORA)**

Enviar mensaje WhatsApp a todos clientes activos:
...
- Crea urgencia (solo Ene-Feb, cupos limitados)
- Todavía rentable para vos (Gs. 120K > Gs. 70-90K actual)

---

**PASO 2: Sesiones Estudiante Finales (Mes 11-12)**

- Continuar pricing estudiante (Gs. 70-90K) hasta graduarte
- Recordar clientes cada sesión: "Este es mi último mes a precios estudiante"
- Ofrecer paquetes: "Comprá 4 sesiones ahora a Gs. 280K, usalas después que me gradúe"
- Objetivo: Pre-vender Gs. 2-3M en sesiones (te da runway lanzamiento)

---

**PASO 3: Lanzamiento Profesional (Mes 13)**
...
### **Resumen Checklist Mes 10:**

- [ ] Investigar requisitos licencia MSPBS
- [ ] Empezar reunir documentos licencia
- [ ] Crear lista compras equipo (presupuesto Gs. 10M)
- [ ] Enviar anuncio transición precio a todos clientes
- [ ] Rastrear respuestas (quién interesado en pricing fundador)
...
## 📅 MES 11: INFRAESTRUCTURA PROFESIONAL (Noviembre 2026)

**Tema Clave:** Construir marca y espacio profesional

---

### **SEMANA 1-2 (Nov 1-14): Preparación Marketing**

#### **Tarea 1: Presencia Online Profesional**

**Objetivo:** Parecer un fisioterapeuta REAL cuando lanzás
...
- [ ] Fotos profesionales:
  - [ ] Headshot (vestimenta profesional)
  - [ ] Fotos espacio trabajo (camilla, equipo)
  - [ ] Antes/después (si clientes consienten)
- [ ] Lista servicios:
...
- [ ] Conseguir primeras 10 reseñas de clientes existentes

**Acción:** Gastar 4-6 horas configurando esto apropiadamente
...
- [ ] 9-12 posts listos ANTES lanzamiento:
  - Contenido educativo (prevención lesiones)
  - Tus credenciales (título, licencia)
  - Testimonios clientes
  - Fotos espacio trabajo
- [ ] Seguir competidores, gimnasios, clubes deportivos

**Inversión tiempo:** 2-3 horas configuración inicial  
**Nota:** NO necesitás ser influencer. Solo parecer profesional.
...
- [ ] Agregar:
  ...
  - Catálogo servicios (con precios)
  - Mensajes auto-respuesta
  - Mensajes "Ausente" para horas no laborables
- [ ] Crear listas broadcast para segmentos clientes
...
- [ ] Diseñar tarjeta simple:
  ...
  - Teléfono + WhatsApp
  - Instagram (si lo tenés)
  - Servicios (brevemente)
- [ ] Imprimir 500 tarjetas (costo: Gs. 150-250K)
...
### **SEMANA 3-4 (Nov 15-30): Selección y Configuración Espacio**

#### **Decisión: ¿Dónde Practicar?**

**Tenés 3 opciones del plan negocios archivado:**
...
**Costo configuración:** Gs. 2-4M (solo equipo)

---

**OPCIÓN 2: Consultorio Compartido (Espacio Clínica Compartido) - COSTO MEDIO**
...
**Costo mensual:** Gs. 1.2-2M alquiler + Gs. 8-12M equipo

---

**OPCIÓN 3: Consultorio Solo (Tu Propia Clínica) - COSTO MÁS ALTO**
...
**Costo inicial:** Gs. 35-50M (alquiler, equipo, construcción)

---

#### **Estrategia Recomendada para Lanzamiento Mes 13:**

**EMPEZAR con Opción 1 (En Casa) O Opción 2 (Espacio Compartido)**
...
#### **Tarea 3: Membresía Asociación Profesional**
...
- ✅ Soporte legal si surgen problemas
- ✅ Red referencia (otros fisios te envían pacientes)
...
- [ ] Asistir reuniones mensuales (opcional pero valioso)

**Acción:** Investigar ahora, unirse en Mes 12 (después graduación)

---

### **Resumen Checklist Mes 11:**

- [ ] Configurar Perfil Negocio Google (versión profesional)
- [ ] Crear cuenta Instagram (opcional)
- [ ] Mejorar a WhatsApp Business
- [ ] Diseñar e imprimir tarjetas presentación (500 unidades)
- [ ] Decidir: Espacio en casa O clínica compartida
- [ ] Si compartido: Visitar 5 clínicas, negociar términos
- [ ] Si casa: Preparar habitación (pintar, organizar, probar con clientes)
- [ ] Investigar membresía AKYFPY
...
## 📅 MES 12: EXÁMENES FINALES + PROCESAMIENTO LICENCIA (Diciembre 2026)

**Tema Clave:** Enfocarse en graduarse, minimizar distracciones

---

### **SEMANA 1-2 (Dic 1-14): Preparación Exámenes Finales**
...
- [ ] No estresarse por negocio (puede esperar 2 semanas)

**Ingresos esperados:** Gs. 600K-1M (sesiones reducidas)

---

### **SEMANA 3 (Dic 15-21): Graduación + Aplicación Licencia**
...
### **SEMANA 4 (Dic 22-31): Receso Feriados + Compra Equipo**
...
### **Resumen Checklist Mes 12:**

- [ ] APROBAR EXÁMENES (prioridad #1)
- [ ] ¡Graduarse! 🎓
- [ ] Recibir título universitario oficial
- [ ] Enviar aplicación licencia MSPBS (con todos documentos)
- [ ] Comprar equipo profesional (si presupuesto permite)
- [ ] Configurar espacio trabajo (casa o clínica compartida)
- [ ] Pre-vender sesiones enero a pricing fundador (Gs. 120K)
...
- Restante: Gs. 4-6M (runway lanzamiento)

---

## 📅 MES 13: LANZAMIENTO PROFESIONAL (Enero 2027)

**Tema Clave:** LANZAR COMO FISIOTERAPEUTA LICENCIADO 🚀

**Supuesto:** Licencia recibida para mediados enero (o finales diciembre si suerte)

---

### **SEMANA 1-2 (Ene 1-14): Lanzamiento Suave (Clientes Existentes)**

**Tenés licencia en mano. ¿Ahora qué?**

#### **Paso 1: Anunciar a Clientes Existentes**
...
#### **Paso 3: Entregar Primeras Sesiones Profesionales**
...
4. **Prescripción ejercicio (5-10 min):** Ejercicios casa, plan próxima sesión
5. **Pago + reserva:** Cobrar tarifa, agendar próxima visita

**Diferencia clave:** Estás tratando lesiones/disfunción, no solo relajación

---

### **SEMANA 3-4 (Ene 15-31): Escalar (Adquisición Nuevos Clientes)**

**Lanzaste con clientes existentes. Ahora conseguir NUEVOS.**
...
- Esperado: 1-2 clientes/mes de redes sociales

---

#### **Proyecciones Financieras - Mes 13:**
...
- Impuestos (RESIMPLE): Gs. 300-500K
- **Gastos totales:** Gs. 2.1-3M

**Ganancia neta:** Gs. 4-5M

**Esto es DOBLE tus ingresos masaje estudiante (Gs. 1.5-2M/mes)**

---

### **Resumen Checklist Mes 13:**

- [ ] Recibir licencia profesional de MSPBS
- [ ] Actualizar todo marketing (Google, Instagram, WhatsApp Business)
- [ ] Anunciar a clientes existentes (pricing fundador)
- [ ] Reservar 30-40 sesiones para enero
- [ ] Configurar formularios admisión profesional + documentación sesión
- [ ] Entregar primeras sesiones fisioterapia profesional
- [ ] Lanzar adquisición nuevos clientes (referencias, asociaciones gimnasios)
- [ ] Rastrear números: sesiones, ingresos, gastos
...
- Ahorros acumulativos: Gs. 18-23M (después 13 meses)

---

## 🎯 ESTRATEGIA POST-LANZAMIENTO (Meses 14-18)

**¿Qué pasa después Mes 13?**
...
### **Ejecutar Plan Negocios Archivado**
...
- [ ] Enviar anuncio transición precio a clientes
...
- [ ] Comprar equipo (si presupuesto permite)
- [ ] Configurar espacio trabajo
...
- [ ] Entregar primeras sesiones fisio profesional
- [ ] Lanzar adquisición nuevos clientes (referencias, gimnasios, Google)
- [ ] Objetivo: 60-80 sesiones, Gs. 7-10M ingresos
...
**Runway:** Mantener mínimo Gs. 5M como fondo emergencia (cubre 2-3 meses si inicio lento)
...
**Transicionaste exitosamente cuando:**

- [ ] Licencia profesional recibida (matriculación MSPBS)
- [ ] RUC actualizado a estado profesional
- [ ] Equipo profesional comprado y configurado
- [ ] Espacio trabajo listo (en casa O clínica compartida)
- [ ] 20+ clientes existentes transicionados a pricing fundador
- [ ] 10+ clientes nuevos adquiridos a tasas profesionales
- [ ] 60+ sesiones/mes entregadas
- [ ] Gs. 7M+ ingresos mensuales (2-3x ingresos estudiante)
- [ ] Sistemas profesionales en lugar (formularios admisión, documentación)
- [ ] Membresía AKYFPY activa

**Timeline:** 4 meses (Oct 2026 → Ene 2027)

**Inversión:** Gs. 10-12M (equipo) + Gs. 1-2M (marketing, configuración)

**Resultado esperado:** Práctica fisioterapia profesional generando Gs. 10-15M/mes para Mes 15-16.
...
**Archivo:** `implementation/07-post-license-transition.md`  
**Estado:** Listo para ejecutar (Meses 10-13)  
**Próxima Revisión:** Mes 9 (Septiembre 2026) - 1 mes antes que transición empiece
